  ...
  return (
    <div ref={contentRef} className="bg-transparent">
      <div className="px-4 py-3">
        ...
        <div className="flex items-center justify-between bg-black/50 rounded-lg px-3 py-3 border border-white/10 backdrop-blur-sm">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2 bg-white/10 hover:bg-white/20 rounded text-white text-xs font-medium transition-colors"
              >
          ...
          {/* Center controls - Solve functionality */}
